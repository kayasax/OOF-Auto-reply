...
6. In production mode, reconcile the recurring schedule as enabled with `browserHeadless: false`. Outlook may require interactive account selection, sign-in, or MFA on any run.
